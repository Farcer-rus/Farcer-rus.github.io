...
$to = 'vitaly1313@bk.ru'; // кому отсылать: адрес e-mail
$from = "manager@".$HTTP_HOST; // адрес, от которого придёт уведомление, желательно указать существующий ящик на хостинге!
